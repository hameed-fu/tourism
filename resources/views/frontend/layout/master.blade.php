...
@include('frontend.layout.header')
				...
				<div class="row align-items-center">
					...
					<div class="col-lg-6 mb-4">
						<div class="banner-image">
							<img src="frontend/images/travel.png" alt>
						</div>
					</div>
				</div>
				<div class="category-main-inner border-t pt-1">
					<div class="row side-slider">
						<div class="col-lg-3 col-md-6 my-4">
							<div class="category-item box-shadow p-3 py-4 text-center bg-white rounded overflow-hidden">
								<div class="trending-topic-content">
									<img src="frontend/images/icons/004-camping-tent.png" class="mb-1 d-inline-block" alt>
						...
						<div class="col-lg-3 col-md-6 my-4">
							<div class="category-item box-shadow p-3 py-4 text-center bg-white rounded overflow-hidden">
								<div class="trending-topic-content text-center">
									<img src="frontend/images/icons/003-hiking.png" class="mb-1 d-inline-block" alt>
						...
						<div class="col-lg-3 col-md-6 my-4">
							<div class="category-item box-shadow p-3 py-4 text-center bg-white rounded overflow-hidden">
								<div class="trending-topic-content">
									<img src="frontend/images/icons/005-sunbed.png" class="mb-1 d-inline-block" alt>
						...
						<div class="col-lg-3 col-md-6 my-4">
							<div class="category-item box-shadow p-3 py-4 text-center bg-white rounded overflow-hidden">
								<div class="trending-topic-content">
									<img src="frontend/images/icons/006-surf.png" class="mb-1 d-inline-block" alt>
						...
						<div class="col-lg-3 col-md-6 my-4">
							<div class="category-item box-shadow p-3 py-4 text-center bg-white rounded overflow-hidden">
								<div class="trending-topic-content">
									<img src="frontend/images/icons/002-safari.png" class="mb-1 d-inline-block" alt>
						...
						<div class="col-lg-3 col-md-6 my-4">
							<div class="category-item box-shadow p-3 py-4 text-center bg-white rounded overflow-hidden">
								<div class="trending-topic-content">
									<img src="frontend/images/icons/008-cycling.png" class="mb-1 d-inline-block" alt>
						...
						<div class="col-lg-3 col-md-6 my-4">
							<div class="category-item box-shadow p-3 py-4 text-center bg-white rounded overflow-hidden">
								<img src="frontend/images/icons/007-hiking-1.png" class="mb-1 d-inline-block" alt>
								<div class="trending-topic-content">
				...
				<div class="col-lg-5 mb-4">
					<div class="trend-item1">
						<div class="trend-image position-relative rounded">
							<img src="frontend/images/destination/destination1.jpg" alt="image">
							<div
				...
				<div class="col-lg-7">
					<div class="row">
						<div class="col-lg-6 col-md-6 col-sm-6 mb-4">
							<div class="trend-item1">
								<div class="trend-image position-relative rounded">
									<img src="frontend/images/destination/destination17.jpg" alt="image">
									<div
										class="trend-content d-flex align-items-center justify-content-between position-absolute bottom-0 p-4 w-100 z-index">
										<div class="trend-content-title">
						...
						<div class="col-lg-6 col-md-6 col-sm-6 mb-4">
							<div class="trend-item1">
								<div class="trend-image position-relative rounded">
									<img src="frontend/images/destination/destination14.jpg" alt="image">
									<div
										class="trend-content d-flex align-items-center justify-content-between position-absolute bottom-0 p-4 w-100 z-index">
										<div class="trend-content-title">
						...
						<div class="col-lg-6 col-md-6 col-sm-6 mb-4">
							<div class="trend-item1">
								<div class="trend-image position-relative rounded">
									<img src="frontend/images/destination/destination15.jpg" alt="image">
									<div
						...
						<div class="col-lg-6 col-md-6 col-sm-6 mb-4">
							<div class="trend-item1">
								<div class="trend-image position-relative rounded">
									<img src="frontend/images/destination/destination16.jpg" alt="image">
									<div
										class="trend-content d-flex align-items-center justify-content-between position-absolute bottom-0 p-4 w-100 z-index">
										<div class="trend-content-title">
				...
				<div class="row d-flex align-items-center justify-content-between">
					<div class="col-lg-6 mb-4 pe-4">
						<div class="about-image overflow-hidden">
							<img src="frontend/images/travel1.png" alt>
						</div>
					</div>
				...
				<div class="row item-slider">
					<div class="col-lg-4 col-md-6 col-sm-6 mb-4">
						<div class="trend-item rounded box-shadow">
							<div class="trend-image position-relative">
								<img src="frontend/images/trending/trending2.jpg" alt="image" class>
								<div class="color-overlay"></div>
							</div>
					...
					<div class="col-lg-4 col-md-6 col-sm-6 mb-4">
						<div class="trend-item box-shadow rounded">
							<div class="trend-image position-relative">
								<img src="frontend/images/trending/trending3.jpg" alt="image">
								<div class="color-overlay"></div>
							</div>
							<div class="trend-content p-4 pt-5 position-relative">
								<div class="trend-meta bg-theme white px-3 py-2 rounded">
					...
					<div class="col-lg-4 col-md-6 col-sm-6 mb-4">
						<div class="trend-item box-shadow rounded">
							<div class="trend-image position-relative">
								<img src="frontend/images/trending/trending4.jpg" alt="image">
								<div class="color-overlay"></div>
							</div>
							<div class="trend-content p-4 pt-5 position-relative">
								<div class="trend-meta bg-theme white px-3 py-2 rounded">
					...
					<div class="col-lg-4 col-md-6 col-sm-6 mb-4">
						<div class="trend-item box-shadow rounded">
							<div class="trend-image position-relative">
								<img src="frontend/images/trending/trending1.jpg" alt="image">
								<div class="color-overlay"></div>
							</div>
							<div class="trend-content p-4 pt-5 position-relative">
								<div class="trend-meta bg-theme white px-3 py-2 rounded">
	...
	<section class="trending pb-0 pt-6" style="background-image: url(frontend/images/shape2.png);">
		<div class="container">
				...
				<div class="row">
					<div class="col-lg-5 mb-4">
						<div class="trend-item1 rounded box-shadow mb-4">
							<div class="trend-image position-relative">
								<img src="frontend/images/trending/trendingb-2.jpg" alt="image" class>
						...
						<div class="trend-item1 rounded box-shadow mb-4">
							<div class="trend-image position-relative">
								<img src="frontend/images/trending/trending-large.jpg" alt="image" class>
								<div class="trend-content1 p-4">
						...
						<div class="trend-item1 rounded box-shadow">
							<div class="trend-image position-relative">
								<img src="frontend/images/trending/trendingb-1.jpg" alt="image" class>
								<div class="trend-content1 p-4">
					...
					<div class="col-lg-7">
						<div class="row">
							<div class="col-lg-6 col-md-6 mb-4">
								<div class="trend-item rounded box-shadow">
									<div class="trend-image position-relative">
										<img src="frontend/images/trending/trending1.jpg" alt="image" class>
										<div class="color-overlay"></div>
									</div>
							...
							<div class="col-lg-6 col-md-6 mb-4">
								<div class="trend-item rounded box-shadow">
									<div class="trend-image position-relative">
										<img src="frontend/images/trending/trending3.jpg" alt="image" class>
										<div class="color-overlay"></div>
									</div>
									<div class="trend-content p-4 pt-5 position-relative bg-white">
										<div class="trend-meta bg-theme white px-3 py-2 rounded">
							...
							<div class="col-lg-6 col-md-6 mb-4">
								<div class="trend-item rounded box-shadow">
									<div class="trend-image position-relative">
										<img src="frontend/images/trending/trending4.jpg" alt="image" class>
										<div class="color-overlay"></div>
									</div>
									<div class="trend-content p-4 pt-5 position-relative bg-white">
										<div class="trend-meta bg-theme white px-3 py-2 rounded">
			...
			<div class="trend-box">
				<div class="row">
					...
					<div class="col-lg-4 mb-4">
						<div class="trend-item box-shadow rounded bg-white">
							<div class="trend-image position-relative">
								<img src="frontend/images/trending/trending2.jpg" alt="image">
					...
					<div class="col-lg-3 col-md-6 col-sm-12 mb-4">
						<div class="team-list rounded">
							<div class="team-image">
								<img src="frontend/images/team/img1.jpg" alt="team">
							</div>
	...
	<section class="testimonial pt-9" style="background-image:url(frontend/images/testimonial.png)">
		<div class="container">
			...
			<div class="row align-items-center">
				<div class="col-lg-5 pe-4">
					<div class="testimonial-image">
						<img src="frontend/images/travel2.png" alt>
					</div>
				</div>
						...
						<div class="col-sm-4 item">
							<div class="testimonial-item1 rounded">
								<div class="author-info d-flex align-items-center mb-4">
									<img src="frontend/images/testimonial/img1.jpg" alt>
	...
	<div class="our-partner p-0">
		<div class="container">
			<div class="partners_inner">
				<ul>
					<li><img src="frontend/images/cl-5.png" alt></li>
					<li><img src="frontend/images/cl-2.png" alt></li>
					<li><img src="frontend/images/cl-3.png" alt></li>
					<li><img src="frontend/images/cl-4.png" alt></li>
					<li><img src="frontend/images/cl-5.png" alt></li>
					<li><img src="frontend/images/cl-3.png" alt></li>
					<li><img src="frontend/images/cl-2.png" alt></li>
					<li><img src="frontend/images/cl-1.png" alt></li>
				</ul>
			</div>
		</div>
	</div>
			...
			<div class="recent-articles-inner">
				<div class="row">
					<div class="col-lg-4">
						<div class="trend-item box-shadow bg-white mb-4 rounded overflow-hidden">
							<div class="trend-image">
								<img src="frontend/images/trending/trending10.jpg" alt="image">
							</div>
								...
								<div class="trend-content">
									...
									<div class="entry-meta d-flex align-items-center justify-content-between">
										<div class="entry-author mb-2">
											<img src="frontend/images/reviewer/2.jpg" alt class="rounded-circle me-1">
					...
					<div class="col-lg-4 col-md-6">
						<div class="trend-item box-shadow bg-white mb-4 rounded overflow-hidden">
							<div class="trend-image">
								<img src="frontend/images/trending/trending12.jpg" alt="image">
							</div>
							<div class="trend-content-main p-4 pb-2">
								<div class="trend-content">
									...
									<div class="entry-meta d-flex align-items-center justify-content-between">
										<div class="entry-author mb-2">
											<img src="frontend/images/reviewer/1.jpg" alt class="rounded-circle me-1">
					...
					<div class="col-lg-4 col-md-6">
						<div class="trend-item box-shadow bg-white mb-4 rounded overflow-hidden">
							<div class="trend-image">
								<img src="frontend/images/trending/trending13.jpg" alt="image">
							</div>
							<div class="trend-content-main p-4 pb-2">
								<div class="trend-content">
									...
									<div class="entry-meta d-flex align-items-center justify-content-between">
										<div class="entry-author mb-2">
											<img src="frontend/images/reviewer/3.jpg" alt class="rounded-circle me-1">
